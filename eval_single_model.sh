...
model_args="pretrained=LLaVA-NeXT/work_dirs/llavanext-google_siglip-so400m-patch14-384-Qwen_Qwen2-7B-Instruct-ov_to_video_am9/checkpoint-1000,model_base=LLaVA-NeXT/checkpoints/LLaVA-Video-7B-Qwen2,conv_template=qwen_1_5,model_name=llava_qwen,max_frames_num=32"
