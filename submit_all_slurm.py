...
MODELS_and_CONFIGS = [
    ...
    ("llava_video_7b_qwen2_05_06_vggt_all_tokens_cross_attn_lora/checkpoint-1400", "lmms-lab/LLaVA-NeXT-Video-7B-Qwen2", 16, "01:00:00"), # Added example nodes and time
]
BENCHMARKS = [
    # "vstrbench",
    "vsibench",
